...
public sealed class ProceduresClient
{
    ...
    public Task<Procedure> ReadAsync(string procedureId, CancellationToken cancellationToken = default)
        => _pipeline.SendAsync<Procedure>(HttpMethod.Get, $"/procedures/{Uri.EscapeDataString(procedureId)}", null, cancellationToken);
    ...
    public Task SetLimitAsync(string procedureId, SetProcedureLimitRequest request, CancellationToken cancellationToken = default)
        => _pipeline.SendAsync(HttpMethod.Put, $"/procedures/{Uri.EscapeDataString(procedureId)}/limit", request, cancellationToken);
    ...
    public Task SetLiveAsync(string procedureId, long version, CancellationToken cancellationToken = default)
        => _pipeline.SendAsync(HttpMethod.Put, $"/procedures/{Uri.EscapeDataString(procedureId)}/versions/{version}/live", null, cancellationToken);

    public Task UnsetLiveAsync(string procedureId, long version, CancellationToken cancellationToken = default)
        => _pipeline.SendAsync(HttpMethod.Delete, $"/procedures/{Uri.EscapeDataString(procedureId)}/versions/{version}/live", null, cancellationToken);
    ...
    public Task SetGatedAsync(string procedureId, long version, SetGatedVersionRequest request, CancellationToken cancellationToken = default)
        => _pipeline.SendAsync(HttpMethod.Put, $"/procedures/{Uri.EscapeDataString(procedureId)}/versions/{version}/gated", request, cancellationToken);

    public Task UnsetGatedAsync(string procedureId, long version, CancellationToken cancellationToken = default)
        => _pipeline.SendAsync(HttpMethod.Delete, $"/procedures/{Uri.EscapeDataString(procedureId)}/versions/{version}/gated", null, cancellationToken);
}
